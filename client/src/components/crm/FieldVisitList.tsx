	...
	return (
		<>
			...
			{checkingInVisitId !== null && (
				<div className="fixed inset-0 z-[4950] bg-black/40 flex items-center justify-center p-4">
			...
			{previewImage && (
				<div
					className="fixed inset-0 z-[4950] bg-black/80 flex flex-col gap-4 items-center justify-center p-4"
