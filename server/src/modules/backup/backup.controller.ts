...
import BackupSchedule from './backupSchedule.model';
import User from '../users/user.model';
import { AuthRequest } from '../../shared/middlewares/auth.middleware';
import { getTenantId, getTenantUserIds } from '../../shared/utils/tenant';
import { sendBackupEmail } from '../../shared/services/email.service';
...
export const exportBackup = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const LeadModel = mongoose.models.Lead || (await import('../crm/leads/lead.model')).default;
    ...
    if (companyIds.length > 0) {
      const CompanyModel = mongoose.models.Company || (await import('../crm/company/company.model')).default;
    ...
    const TenantModel = mongoose.models.Tenant || (await import('../settings/tenant.model')).default;
