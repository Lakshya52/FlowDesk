...
import { getTenantUserIds, getTenantId } from '../../shared/utils/tenant';
import { emitTaskCreated, emitTaskUpdated, emitTaskDeleted } from '../../sockets/taskSocket.service';
...
export const getTasks = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
        ...
        if (search) {
            ...
            const AssignmentModel = (await import('../assignments/assignment.model')).default;
            const CompanyModel = (await import('../crm/company/company.model')).default;
        ...
        if (isBoardMember) {
            ...
            const Team = (await import('../teams/team.model')).default;
            const AssignmentModel = (await import('../assignments/assignment.model')).default;
