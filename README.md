...
| **Canvas** | Private infinite canvas (`CanvasNote x/y/width/height/color/connections`) | `CanvasNote.ts:20`, `routes/canvas.ts:9`, `CanvasPage.tsx` |
